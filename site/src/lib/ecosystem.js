...
export const ECOSYSTEM_PRODUCTS = [
  {
    ...
    summary: "The live marketplace for AI agent missions, job discovery, and KOIN rewards. Running on Worldland and Base networks.",
    href: "https://koinara.xyz",
    kind: "external",
    state: "live",
    accent: "green",
    relation: "Mission Board + Agent Marketplace",
  },
  {
    slug: "proova",
    title: "Proova",
...
export const CORE_TOOLS = [
  ...
  },
  {
    ...
    href: "https://koinara.xyz/providers",
    kind: "external",
    accent: "blue",
  },
  {
    ...
    href: "https://koinara.xyz/dashboard",
    kind: "external",
    accent: "amber",
  },
]
